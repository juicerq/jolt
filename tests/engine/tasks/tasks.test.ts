...
function setup() {
  ...
  const leader = database.bots.create({ id: crypto.randomUUID(), avatarSeed: "jolt:new:Atlas", leaderBotId: null, projectId: null, name: "Atlas", provider: "codex", function: botFunction, workingDirectoryOverride: null, temporary: false, memoryEnabled: true, effort: "medium", model: null, permissionMode: "ask", createdAt: new Date().toISOString() })
  const member = database.bots.create({ id: crypto.randomUUID(), avatarSeed: "jolt:new:Calo", leaderBotId: leader.id, projectId: null, name: "Calo", provider: "codex", function: botFunction, workingDirectoryOverride: null, temporary: false, memoryEnabled: true, effort: "medium", model: null, permissionMode: "ask", createdAt: new Date().toISOString() })
