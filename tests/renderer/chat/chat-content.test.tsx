...
describe("ChatContent", () => {
  test("renders the Markdown a Bot sends as readable chat content", () => {
    ...
    expect(markup).toContain("<h2>Resultado</h2>")
    expect(markup).toContain("<ul>")
    expect(markup).toContain("<code>inline()</code>")
    expect(markup).toContain("chat-code-block")
    expect(markup).not.toContain("chat-code-header")
    expect(markup).not.toContain("TypeScript")
    expect(markup).toContain('class="icon-button chat-code-copy"')
