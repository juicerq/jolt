...
const base = { avatarSeed: "jolt:new:member", leaderBotId: "marina", projectId: null, provider: "codex" as const, function: { outcome: "Revisão pronta", description: "Revisar" }, workingDirectoryOverride: null, memoryEnabled: true, effort: "medium" as const, model: null, permissionMode: "ask" as const, effectiveWorkingDirectory: "/tmp/jolt", createdAt: "2026-09-01T10:00:00.000Z", colleagueIds: [] }
