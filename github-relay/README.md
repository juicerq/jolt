...
O relay recebe webhooks e entrega eventos e tokens de instalação ao Mimo. Para conectar uma instalação inteira, a pessoa precisa autorizar o GitHub App e comprovar que é dona da conta pessoal ou administradora da organização.
...
Desconectar uma Conta revoga sua credencial no relay antes de apagá-la no Mimo. Tokens de instalação já emitidos pelo GitHub continuam válidos até a expiração informada pelo GitHub.
