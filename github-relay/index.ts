...
const github = createGithubApp({ appId: environment.GITHUB_APP_ID, appSlug: environment.GITHUB_APP_SLUG, privateKey: environment.GITHUB_APP_PRIVATE_KEY, webhookSecret: environment.GITHUB_WEBHOOK_SECRET })
const app = createRelayApp({ database, github })
const server = Bun.serve({ hostname: "0.0.0.0", port: environment.PORT, fetch: app.fetch })
