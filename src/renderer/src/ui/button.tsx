...
const variantClassNames = {
  ...
  secondary: "border border-outline-strong bg-surface-raised font-medium text-secondary hover:bg-surface-hover hover:text-primary focus-visible:bg-surface-hover focus-visible:text-primary active:bg-surface-active disabled:opacity-60",
