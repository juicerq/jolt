...
export function Dialog({ eyebrow, title, onClose, children }: { eyebrow: string; title: string; onClose: () => void; children: ReactNode }) {
  ...
  return (
    <DialogFrame titleId={titleId} className="fixed inset-0 m-auto box-border flex max-h-[calc(100vh-48px)] w-[min(480px,calc(100%-48px))] max-w-none flex-col overflow-hidden rounded-[18px] border border-outline-strong bg-surface-raised p-0 text-primary backdrop:bg-transparent shadow-[0_2px_8px_rgb(0_0_0/45%),0_28px_90px_rgb(0_0_0/58%)]" onClose={onClose}>
...
export function ConfirmationDialog({ icon, title, onClose, children, actions }: { icon: ReactNode; title: string; onClose: () => void; children: ReactNode; actions: ReactNode }) {
  ...
  return (
    <DialogFrame titleId={titleId} className="fixed inset-0 m-auto box-border flex max-h-[calc(100vh-48px)] w-[min(480px,calc(100%-48px))] max-w-none flex-col overflow-hidden rounded-[18px] border border-outline-strong bg-surface p-2 text-primary backdrop:bg-transparent shadow-[0_2px_8px_rgb(0_0_0/45%),0_28px_90px_rgb(0_0_0/58%)]" onClose={onClose}>
