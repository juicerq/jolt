  ...
  return (
    <div className="mb-3 grid gap-1.5 text-support text-muted">
      <details className="group/activity max-w-[620px] transition-[opacity,transform] duration-180 ease-out starting:translate-y-1 starting:opacity-0 motion-reduce:transition-none">
        ...
        <div className={steps.length === 1 ? "relative mt-1.5 mb-1 ml-[14px] grid py-1 pl-4 before:pointer-events-none before:absolute before:inset-y-0 before:left-0 before:w-2.5 before:rounded-l-md before:border-y before:border-l before:border-outline" : "mt-2 mr-0 mb-1 ml-[30px] grid gap-0.5 pl-3"}>
