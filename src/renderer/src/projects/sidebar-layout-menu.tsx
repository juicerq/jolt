...
const modes = [
  ...
  { value: "compact", label: "Avatares e nomes", icon: RectangleGroupIcon },
...
export function SidebarLayoutMenu() {
  ...
  return <>
    <span className="grid" style={anchor.trigger}>
      <IconButton size={28} label="Tamanho da sidebar" tooltipPlacement="bottom" popoverTarget={popoverId}><ViewColumnsIcon aria-hidden="true" /></IconButton>
    </span>
