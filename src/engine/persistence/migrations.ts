...
import temporaryMembers from "../../../drizzle/20260901112808_temporary-members/migration.sql" with { type: "text" }
...
export const migrations = [
  ...
  { name: "20260901112808_temporary-members", timestamp: 1788262088000, sql: temporaryMembers },
