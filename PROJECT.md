...
- um Bot que trabalha em uma codebase;
- um Bot que lê e organiza e-mails;
- um Líder de vendas com Integrantes que pesquisam clientes e escrevem mensagens;
- um Integrante temporário para uma tarefa específica.

Cada Bot tem sua própria função, instruções e histórico. Todas as conversas e tarefas ficam visíveis para você.
